...
const Rankings = () => {
  const topUsers = [
    { id: 1, name: 'Luna', rank: 1, distance: '124.5', pet: 'Aqua Pup', img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Luna' },
    { id: 2, name: 'Kai', rank: 2, distance: '118.2', pet: 'Zen Fox', img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Kai' },
    { id: 3, name: 'Mina', rank: 3, distance: '105.8', pet: 'Mint Cat', img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Mina' },
  ];
              ...
              {others.map((user, i) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-[10px] font-black text-text-muted uppercase tracking-widest mt-2">Level 4 Zen Runner</div>
                  </div>
