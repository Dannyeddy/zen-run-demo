...
const PetSpace = () => {
  ...
  const handleFeed = () => {
    ...
    setIsFeeding(true);
    // Sequence: 
    // 1. Food icon appears and moves to pet
    // 2. Pet reacts
    // 3. Stats update
    // 4. Finished
            ...
            >
              ...
              <AnimatePresence>
                {isFeeding && (
                  ...
                  >
                    <div className="bg-white p-6 rounded-full shadow-2xl border-4 border-brand/20">
                      <Utensils size={64} className="text-brand" fill="currentColor" />
                    </div>
                  </motion.div>
                )}
                {showHeart && (
